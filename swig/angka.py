...
def agx_string_from_double_set(set, val):
    return _angka.agx_string_from_double_set(set, val)
...
def agx_vector_devide_by_value(vec, val):
    return _angka.agx_vector_devide_by_value(vec, val)
...
def agx_matrix_devide_by_value(mat, val):
    return _angka.agx_matrix_devide_by_value(mat, val)
...
def agv_color_pallete_canvas_set(can, line, size):
    return _angka.agv_color_pallete_canvas_set(can, line, size)
...
def agv_set_color_alpha_line_scatter(can, line, red, green, blue, alpha):
    return _angka.agv_set_color_alpha_line_scatter(can, line, red, green, blue, alpha)
